...
export function renderApplication() {
    return `
            <div class="notice-input-div">
              <label>
                <span>ID : </span>
                <input id="NOTICE-ID" type="text" value="" readonly class="notice-input">
              </label>
            </div>
            <div class="notice-input-div">
              <label>
                <span>ROLE : </span>
                <input id="NOTICE-ROLE" type="text" value="" readonly class="notice-input">
              </label>
            </div>
            <div class="notice-input-div">
              <label>
          ...
          <div class="notice-input-div">
              ...
              <!-- 드래그&드롭 영역 -->
              <div id="notice-dropzone" class="dropzone" tabindex="0" aria-label="여기에 파일을 끌어다 놓거나 클릭하여 선택">
                여기에 파일을 드래그하거나 클릭해 선택
              </div>
              <!-- 선택/드롭된 파일 목록 표시 -->
              <ul id="notice-file-list" class="file-list"></ul>
            </div>
            <div class="notice-input-div">
            <label>
              <span>TITLE</span>
            ...
            <div class="notice-input-div">
              <button type="button" onclick="openNoticePreview()" class="notice-input-btn">미리 보기</button>
